var $repeats=new Array();
	...
	*/
	...
	$repeats[100]=Array(' 48','tdgssasgqqqessvlspsgqastssolgvg');
	$repeats[101]=Array(' 49','tdgssagdqqqgsgvssqsgqastssolg');
	$repeats[102]=Array(' 50','tdsssagdrqqgsgvssqsgqastssolg');
	$repeats[103]=Array(' 51','tdsssagdqrqgsgvssqsgqastssolg');
	$repeats[104]=Array(' 52','tdsssasgqqqvssvssqsdastssolg');
	$repeats[105]=Array(' 53','tdsssasgqqqessvlppsgqastssolg');
	$repeats[106]=Array(' 54','lhsssasgqqqessvsfqtgqastssolg');
	$repeats[107]=Array(' 55','tdsssagdqhqessvssqsgqastssolg');
	$repeats[108]=Array(' 56','tdsssasgeqqessvlspsgeastssolg');
	$repeats[109]=Array(' 57','tdsssasgqhqesivssqseastssolw');
	$repeats[110]=Array(' 58','tdgssasgqqqessvlsqsdeastssolg');
	$repeats[111]=Array(' 59','tdgssasgqqqessvlsqsdeastssosg');
	$repeats[112]=Array(' 60','adgssagdqqqessvssqsgastssolg');
	$repeats[113]=Array(' 61','tdsssagdqqqessvssqsgastssolg');
	$repeats[114]=Array(' 62','tdsssagdqqqessvssqsdastssolg');
	$repeats[115]=Array(' 63','agsssasgqqqessvlsqsgqastssolg');
	$repeats[116]=Array(' 64','agsssaggqqqessvssqseastssolgg');
	$repeats[117]=Array(' 65','adsssasgqqqessvlsqseastssolgg');
	$repeats[118]=Array(' 66','tdsssagdqqqessvssqsdastssolr');
	$repeats[119]=Array(' 67','tdsssasgqqqessvlsqsgqaspssolg');
	$repeats[120]=Array(' 68','agrssasgqqqessvlsqsgqastssolg');
	$repeats[121]=Array(' 69','adgssagdqqqessvssqsgaspssolg');
	$repeats[122]=Array(' 70','tdsssagdqqqessassqsgastssolg');
	$repeats[123]=Array(' 71','tdsssagdqqhessvssqsgartssolg');
	$repeats[124]=Array(' 72','adsssagdqqessvssqsgastssolg');
	$repeats[125]=Array(' 73','tdsssagdqqqesgvssqsgqastssolg');
	$repeats[126]=Array(' 74','adsssasgqqqesgvpsqsgqastssolg');
	$repeats[127]=Array(' 75','adgssagdqqqesgvlsqsgqastssolg');
	$repeats[128]=Array(' 76','tdsssasgqqqesgvssqsdastssolg');
	$repeats[129]=Array(' 77','adsssvsgqqqessvlsqsgqastssolg');
	$repeats[130]=Array(' 78','tdsssasgqqqessvlsqssqastss~olg');
	$repeats[131]=Array(' 79','tdsssasgqpqessvlcvsdlsstssolg');
	$repeats[132]=Array(' 80','adsssagdqqqessvssqsgqastssolg');
	$repeats[133]=Array(' 81','tdsssagdqqqessvssqsgqastssolg');
	$repeats[134]=Array(' 82','adsssasgqqqessvlsqsdlsstwsolg');
	$repeats[135]=Array(' 83','tdsssasgqqqesgvlsqsgqastssosg');
	$repeats[136]=Array(' 84','adsssagnqqqessvssqsgastssolg');
	$repeats[137]=Array(' 85','adgssagdqqqessvssqsgagpssolg');
	$repeats[138]=Array(' 86','tdsssagdqqqessvssksgastssolg');
	$repeats[139]=Array(' 87','adsssasgqqqessvlsqsiqastssolr');
	$repeats[140]=Array(' 88','tdsssasgqkqessvlpqsgqastssolg');
	$repeats[141]=Array(' 89','adsssaggqqqessessqsdqastssklg');
	$repeats[142]=Array(' 90','adsssaggqqqessvssqsdqassssolg');
	$repeats[143]=Array(' 91','tdsssasgqqqessvssqsgqastssolr');
	$repeats[144]=Array(' 92','adsssasgqqqesgvlsqstqastssolr');
	$repeats[145]=Array(' 93','ndsssasgqqqessvlspsgqastssolgvg');
	$repeats[146]=Array(' 94','adsssasgqqqesgvlsqsgqastssolgvg');
	$repeats[147]=Array(' 95','adssstggqqqessvsshseastssolgg');
	$repeats[148]=Array(' 96','adsssasgqqqessvlsqseastsshlgg');
	$repeats[149]=Array(' 97','adssspsgqqqessvssqseaatssevrg');
	$repeats[150]=Array(' 98','adsssasgqqqessvlsqseastssolg');
	$repeats[151]=Array(' 99','adsswpsgnrqespvlshsytttssolrg');
	$repeats[152]=Array(' 100','tdsssasgqqqesgvlsqsgqastssolg');
	$repeats[153]=Array(' 101','agsssaggqqqessvssqsdqattssolg');
	$repeats[154]=Array(' 102','adsssaggqqqessvssqsdqantsshlg');
	$repeats[155]=Array(' 103','adsssasgqqqgssvlsqsgqastssolg');
	$repeats[156]=Array(' 104','adsssesgqqqessvlsqsgqastssolg');
	$repeats[157]=Array(' 105','tdsssaggqqqessvssqsdastssolg');
	$repeats[158]=Array(' 106','adgssagdqqqessvssqsgqastssolg');
	$repeats[159]=Array(' 107','adsssasdqqqesgvpsqseastssolg');
	$repeats[160]=Array(' 108','adsssasgvlsqsgqastspolg');
	$repeats[161]=Array(' 109','adsssasgqqpessvlspsgqastssolg');
	$repeats[162]=Array(' 110','adsssasgqqresgvlsqsgqastsshlg');
	$repeats[163]=Array(' 111','tdsssasgrqqessvlsqsdqastssosr');
	$repeats[164]=Array(' 112','tdsssasgqqqessvlsqsdqactssolg');
	$repeats[165]=Array(' 113','tdsssasgqqressvlsqsdqastssolg');
	$repeats[166]=Array(' 114','tdsssagdhqqgsgvssqsgeastssolg');
	$repeats[167]=Array(' 115','tdsssagdhqqgsgvssqsgqastssolg');
	$repeats[168]=Array(' 116','tdsssasgqqqestvssqsdastssolg');
	...
	$repeats[172]=Array(' 120','tdsssasgqqqessvssqsddatsssols');
	$repeats[173]=Array(' 121','tdsssasghqrestvlsrsdqastssolg');
	$repeats[174]=Array(' 122','tdsssasghqrestvlsqsdqastssosg');
	$repeats[175]=Array(' 123','tdsssasgqqrestvlsqsdqastsshsg');
	$repeats[176]=Array(' 124','tdsssasgqqrestvlsqsdqastssolg');
	$repeats[177]=Array(' 125','tdsssasgqhqessvlsqsdqastssosg');
	$repeats[178]=Array(' 126','tdsssasgqqqesnvlspcgrastssolg');
	$repeats[179]=Array(' 127','adsssagdqqkesnvssqtgqaspsshlr');
	$repeats[180]=Array(' 128','tdsssagdqqqgsgvsaqsgqaspwsolg');
	$repeats[181]=Array(' 129','adsssasgrhqksnvssqseactssolg');
	$repeats[182]=Array(' 130','tdsssasgqwcessvssqseastssolg');
	$repeats[183]=Array(' 131','tdsssasgqqqessvssqseastssolr');
	...
	$repeats[187]=Array(' 135','ddssstgdqqqssvvspsddaarssolwt');
	$repeats[188]=Array(' 136','adsssasgqqqessvssqseastssolrg');
	$repeats[189]=Array(' 137','adsssasgqqqesivssqseartssolgg');
	$repeats[190]=Array(' 138','adsssasgqqqessvssqseassssolgg');
	$repeats[191]=Array(' 139','adsssasgqqqesivssqseastssolgg');
	$repeats[192]=Array(' 140','adsssasgqqqesgvlsqsgqastssolr');
	$repeats[193]=Array(' 141','tdsssasgqqqesgvlsqsgqastssolr');
	$repeats[194]=Array(' 142','tdsssasgqqqessvlpqsghartssosg');
	$repeats[195]=Array(' 143','tdsssgsgqqqessvlsqssqarsssolg');
	$repeats[196]=Array(' 144','ddsssasgqqqessvlpqsgqdstssosg');
	$repeats[197]=Array(' 145','gdsssssgqqqessvlsqssqastssolg');
	$repeats[198]=Array(' 146','adsssagnqqqessvssqseastssolg');
	$repeats[199]=Array(' 147','tdsssagnqqqessvssqsgagtssolg');
	$repeats[200]=Array(' 148','tdsssagdqqqessvssqsgasassklr');
	$repeats[201]=Array(' 149','tdsssagdqqqessvsslsgastssolg');
	$repeats[202]=Array(' 150','tdsssagdqkqessvssqigastssklg');
	$repeats[203]=Array(' 151','ansssasgqqeessvlsqsdqastssolg');
	$repeats[204]=Array(' 152','tdsssasgqqqessvlsqsdqastssolr');
	$repeats[205]=Array(' 153','tdsspemgqqqessvfsqsaqastssosg');
	$repeats[206]=Array(' 154','adsssasgqqqessvlsqsdqastssosg');
	$repeats[207]=Array(' 155','ansssasgqqqessvlsqsgqastssolg');
	$repeats[208]=Array(' 156','adsssagnqqqessvssqsghastssolg');
	$repeats[209]=Array(' 157','tdswsasgqqqessvlsqsdqastssolg');
	$repeats[210]=Array(' 158','absssasgqqqessvlsqsdqstssolg');
	$repeats[211]=Array(' 159','adsssasgqqqessvpsqseaatssol');
	$repeats[212]=Array(' 160','angssasgqqqessvlsqsdqastssolg');
	$repeats[213]=Array(' 161','adsssasgqqqessvlsqsdeastssolg');
